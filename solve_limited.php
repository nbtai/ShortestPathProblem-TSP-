 ...
 * Date: 14/05/2017
 * Time: 9:58 PM
 * Source code copy from Ross Scrivener, the owner of blog http://scrivna.com
 */
...
while(!feof($cities)) {
    ...
    $tsp->add($city_oords[0],$city_oords[1],$city_oords[2]);
}
fclose($cities);
...
var_dump($tsp->matching_shortest_routes());
